...
public class UnderSamplingFilterTest extends TestCase {
    ...
    @Test
    public void testFilterUnderSampling() throws BlueprintPersistenceException, BlueprintNotFoundException {
        InMemoryBlueprintPersistence ibpp=new InMemoryBlueprintPersistence();
        Filter bpf = new UnderSampling();
        //Blue print
        ...
        assertEquals("Points filtered by Redundancy", blueprintRes.getPoints().size(), 2);
    }

    @Test
    public void testFilterUnderSamplingPar() throws BlueprintPersistenceException, BlueprintNotFoundException {
        InMemoryBlueprintPersistence ibpp=new InMemoryBlueprintPersistence();
        Filter bpf = new UnderSampling();
        //Blue print
    ...
    @Test
    public void testFilterUnderSamplingImPar() throws BlueprintPersistenceException, BlueprintNotFoundException {
        InMemoryBlueprintPersistence ibpp=new InMemoryBlueprintPersistence();
        Filter bpf = new UnderSampling();
        //Blue print
